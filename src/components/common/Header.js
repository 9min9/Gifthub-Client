  ...
  const logoutMenu = (
    <>
      <li id="nav-signup-li" className="u-s-m-r-6">
        <a href="/signup"><i className="fas fa-user-plus"></i>
          <span>회원가입</span></a></li>
        ...
        <div className="container">
          <div id="primary-nav" className="primary-nav">
            ...
            <div className="menu-init" id="navigation">
              <button className="btn btn--icon toggle-button toggle-button--secondary fas fa-cogs responsible-hidden"
                      type="button"></button>
              <button className="btn btn--icon toggle-button toggle-button--secondary fas fa-cogs responsible-hidden"
                      type="button"></button>
        ...
        <div className="container">
          <div className="secondary-nav">
            ...
            <div className="menu-init" id="navigation2">
              <button className="btn btn--icon toggle-button toggle-button--secondary fas fa-cog responsible-hidden"
                      type="button"></button>
              <div className="ah-lg-mode">
                <span className="ah-close">✕ Close</span>
                  ...
                  <li className="has-dropdown">
                    ...
                    <div className="mini-cart">
                      <form action="/payment/checkout" method="get" name="checkout-form">
                        <div className="mini-product-container gl-scroll u-s-m-b-15" id="mini-cart-list">
                        </div>
                        <div className="mini-product-stat">
                          ...
                          <div className="mini-action">
                            <Link to={"/payment/checkout"} className="mini-link btn--e-brand-b-2"
                                    style={{width: "100%", cursor: "pointer"}}>
                              결제 하기
                            </Link>
                            <Link to="/carts" className="mini-link btn--e-transparent-secondary-b-2">장바구니 보기</Link>
                          </div>
                        </div>
                      </form>
                    </div>
